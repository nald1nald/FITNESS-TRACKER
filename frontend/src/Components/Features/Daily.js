          ...
          <div>
            <div className="first-daily">
              <div>
                ...
                <div>
                  <Link to="/features/fitness-tracker">
                    Start
                  </Link>
                </div>
              </div>
              <div className="image-first"><img src={firstdaily} alt="first daily" /></div>
            </div>

            <div className="second-daily">
              <div>
                <p>Nutrition</p>
                <p className="move">Eat the Rainbow: Vary your diet with colorful fruits and vegetables.</p>
                <div>
                <Link to="/features/nutrition">
                    Learn More
                  </Link>
                </div>
              </div>
              <div className="image-second"><img src={fruits} alt="fruits" /></div>
            </div>
